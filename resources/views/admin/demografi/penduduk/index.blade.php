            ...
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted">Total {{ number_format($total) }} Jiwa</small>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody class="table-border-bottom-0">
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST"
                                                action="{{ route('demografi.penduduk.destroy', $item->id) }}">
                                                @csrf @method('DELETE')
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <form action="" method="POST" class="mt-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Jenis penduduk</label>
